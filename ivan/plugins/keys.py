...
@click.option("--port", "--p", default="", help="Provide the Security Center Port")
...
def keys(clear, access_key, secret_key, hostname, port):
    ...
    if access_key == "" or secret_key == "":
        ...
        if clear:
            ...
            port = input("Please provide the port for Security Center : ")
        else:
            ...
            port = getpass.getpass("Please provide the port for Security Center :")
